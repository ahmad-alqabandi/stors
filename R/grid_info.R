...
#' print(normal_grid)
#'
#' # `print_grids()` prints all grids stored by the user on their machine. To see this, we first save 'normal_grid' using `save_grid()`
...
#'
#' @description
#' This function stores grids generated by the `build_grid()` function on the user's machine. It is useful when users want to reuse a grid across multiple R sessions.
#'
...
#' print(normal_grid)
#'
#' # Then, we can save this grid on the user's machine using `save_grid()` with the name "normal"
#' save_grid(normal_grid, "normal")
#'
#' # To make sure the 'normal_grid' has been stored on the machine, we can print all saved grids using `print_grids()`
#' print_grids()
#' 
...
#' print(normal_grid)
#'
#' # Then, save this grid on the user's machine using `save_grid()` with the name "normal"
#' save_grid(normal_grid, "normal")
#'
