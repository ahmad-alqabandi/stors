...
#' @noRd
truncate_error_checking <- function(xl, xr, lb, rb) {
  stopifnot(
    ...
    "xl must be greater than the density lower bound" = (xl >=  lb),
    "xr must be smaller than the density upper bound" = (xr <= rb)
  )
