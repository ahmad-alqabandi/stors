...
static const R_CallMethodDef callMethods[]  = {
  ...
  {"srnorm", (DL_FUNC) &srnorm, 2},
  {"srnorm_sym", (DL_FUNC) &srnorm_sym, 2},
  {"srnorm_trunc_nav", (DL_FUNC) &srnorm_trunc_nav, 2},
  {"srnorm_trunc", (DL_FUNC) &srnorm_trunc, 7},
  {"old_srnorm", (DL_FUNC) &old_srnorm, 1},
  {"old_srnorm_trunc_nav", (DL_FUNC) &old_srnorm_trunc_nav, 2},
  {"old_srnorm_trunc", (DL_FUNC) &old_srnorm_trunc, 7},
  {"srexp", (DL_FUNC) &srexp, 2},
  {"srexp_trunc_nav", (DL_FUNC) &srexp_trunc_nav, 2},
  {"srexp_trunc", (DL_FUNC) &srexp_trunc, 7},
  {"laplace", (DL_FUNC) &laplace, 2},
  {"laplace_trunc_nav", (DL_FUNC) &laplace_trunc_nav,2},
  {"laplace_trunc", (DL_FUNC) &laplace_trunc, 7},
